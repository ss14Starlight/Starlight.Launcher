...
servers-menu-no-online-servers = Сейчас нет серверов онлайн.
servers-menu-no-matched-servers = Нет серверов которые бы подходили под фильтры.
servers-menu-clear-filters = Очистить фильтры
