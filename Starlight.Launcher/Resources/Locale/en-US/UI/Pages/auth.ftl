...
auth-menu-attach-login-error = The browser login didn't finish in time. Please try again and complete it within 5 minutes.
auth-menu-attach-connect-fail = Couldn't reach the Starlight auth server. Check your connection and try again.
