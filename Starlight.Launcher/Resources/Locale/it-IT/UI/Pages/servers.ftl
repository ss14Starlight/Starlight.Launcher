...
servers-menu-no-online-servers = Non ci sono server online.
servers-menu-no-matched-servers = Nessun server corrisponde ai tuoi filtri.
servers-menu-clear-filters = Cancella filtri